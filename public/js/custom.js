jQuery(document).ready(function () {
  ...
  var slider = new Swiper(
    ".bw_testimonial_two_section .bw_testimonial_two_content",
    {
      slidesPerView: 1,
      spaceBetween: 0,
      loop: true,
  ...
  var thumbs = new Swiper(
    ".bw_testimonial_two_section .bw_testimonial_two_img",
    {
      slidesPerView: 1,
      spaceBetween: 10,
      centeredSlides: true,
  ...
  jQuery("body").on("click", ".accordion .accordion-tabs", function () {
    ...
    jQuery(
      ".bw_faq_page_section_2 .accordion .accordion-tabs h5 span.accordion_icon"
    ).text("expand_more");
    jQuery(
